...
|--------|--------|----------------|------|
| c64m HostFS (SD2IEC-shaped folder volume) | active (Phase 0–3 / PR1–PR8 landed; PR9 snapshot remain) | 2026-08-31 | [`c64/hostfs-sd2iec-folder-volume.md`](c64/hostfs-sd2iec-folder-volume.md) |
