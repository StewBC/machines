...
|--------|--------|----------------|------|
| c64m HostFS (SD2IEC-shaped folder volume) | active (Phase 0–1 CD landed; SEQ/`@:`/D64-CD later) | 2026-08-30 | [`c64/hostfs-sd2iec-folder-volume.md`](c64/hostfs-sd2iec-folder-volume.md) |
