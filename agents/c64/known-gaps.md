...
| SID 8580 / analog blend / paddles | 6581-style functional model. No runtime chip switch. Combined-wave is a deterministic approximation. Generic paddles stay `$FF`; CBM 1351 uses a 512 Ø2 pot latch (sample on mouse-port mux select; keep across other edges). |
