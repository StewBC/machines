...
| SwiftLink IRQ/NMI, baud pacing, Hayes 1s `+++` guard-time, inbound ATA | Soft-attach SwiftLink/Turbo232 (6551 + Hayes + outbound TCP) is shipped polled-only. Optional polish is PR7 in `design/c64/swiftlink-teensyrom.md`. |
