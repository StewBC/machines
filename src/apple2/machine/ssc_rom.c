/* Apple Super Serial Card firmware part 341-0065-A (2K).
   Not Unlicense — embedded for compatibility only. */
#include "ssc_rom.h"

const uint8_t ssc_rom[SSC_ROM_SIZE] = {
...
const int ssc_rom_size = SSC_ROM_SIZE;
