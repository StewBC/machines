...
uint8_t mockingboard_read_via_port_a(const struct apple2 *m, uint8_t slot, uint8_t pair_index);
...
uint8_t mockingboard_irq_pending(struct apple2 *m);
...
uint8_t mockingboard_read_cn(struct apple2 *m, MOCKINGBOARD *mb, int slot, uint16_t address, uint8_t slot_offset);
void mockingboard_write_cn(struct apple2 *m, MOCKINGBOARD *mb, int slot, uint16_t address, uint8_t slot_offset, uint8_t value);
uint8_t mockingboard_read(struct apple2 *m, MOCKINGBOARD *mb, int slot, uint16_t address, uint8_t reg);
void mockingboard_write(struct apple2 *m, MOCKINGBOARD *mb, int slot, uint16_t address, uint8_t reg, uint8_t value);
