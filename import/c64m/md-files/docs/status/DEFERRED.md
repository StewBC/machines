...
- Save-state frontend UI/hotkeys/CLI, runtime path/hash manifests,
  self-contained snapshot embedding, cross-version migration, and full 1541
  CPU/VIA/drive-side state capture are deferred.
