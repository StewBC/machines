...
- 47 tests in `tests/machine/test_sid.c` (register, voice, sync/ring/combined waveform behavior, ADSR, mixer/filter/routing, filter regression, output conditioning, audio-flow smoke); all pass.
