...
- `inspector.md` - **I0–I4 landed**: Inspector time-travel
...
unit/control tests, Inspector I0–I4 (`runtime_inspector`,
`runtime_inspector_replay`, `runtime_inspector_mode`,
`inspector_control_integration`, Misc Inspector tab, max/warp Record wipe), and `help_view`,
