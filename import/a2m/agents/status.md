...
| Control port | **A2M/7 product-wired** (BP + frame ring + history + softswitches + save/load-state + select-disk / set-disk-writable). Epic: [`remote-debug.md`](remote-debug.md) |
