...
const int a2p_rom_size = sizeof(a2p_rom) / sizeof(a2p_rom[0]);

uint8_t a2p_character_rom[] = {
...
const int a2p_character_rom_size = sizeof(a2p_character_rom) / sizeof(a2p_character_rom[0]);
...
const int a2ee_rom_size = sizeof(a2ee_rom) / sizeof(a2ee_rom[0]);

uint8_t a2ee_character_rom[] = {
    ...
    0xFC, 0xFC, 0xFC, 0xDC, 0x9C, 0x00, 0x9E, 0xDE, 0xFE, 0x00, 0xFE, 0x00, 0xFE, 0x00, 0x00, 0xFE,
...
const int a2ee_character_rom_size = sizeof(a2ee_character_rom) / sizeof(a2ee_character_rom[0]);

uint8_t disk2_rom[2][256] = {
    {
        // This is the 13 sector rom
...
uint8_t franklin_ace_display_rom[] = {
    ,
    ...
    ,
};

const int franklin_ace_display_rom_size = sizeof(franklin_ace_display_rom) / sizeof(franklin_ace_display_rom[0]);

uint8_t franklin_ace_character_rom[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0xE0, 0x90, 0x90, 0x90, 0xE8, 0x08, 0x08, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const int franklin_ace_character_rom_size = sizeof(franklin_ace_character_rom) / sizeof(franklin_ace_character_rom[0]);

uint8_t smartport_rom[] = {
...
const int smartport_rom_size = sizeof(smartport_rom) / sizeof(smartport_rom[0]);
