...
"\n"
"The <#QU>selector buttons<#NM> described in the Disassembly View, mouse controls section are also available in the memory view section.\n"
,
...
"\n"
"<#QU>[6.0][Eject][Save][Insert][Swap (1/2)] This is disk 1.po<#NM>\n"
"\n"
...
"\n"
"<#QU>[6.0][Eject][Save][Insert][Swap (2/2)] This is disk 2.po<#NM>\n"
"\n"
...
"\n"
"<#H3>Configure INI<#NM>\n"
"The Configure INI button opens the <#QU>Machine Configuration Dialog<#NM>.  See the <#QU>Dialogs<#NM> section for more details.  Through this button, the startup <#QU>INI<#NM> files can be created and edited.\n"
"\n"
"<#H3>Load INI<#NM>\n"
"This button opens a file browser that allows selection of a startup INI file.  Selection a new INI file will <#QU>reboot<#NM> the emulator and it will come up configured using the newly selected INI file.\n"
"\n"
...
"\n"
"The dialog also includes an <#QU>In Bank<#NM> row that selects which memory bank the breakpoint applies to. <#QU>Map<#NM> matches the CPU's current mapping, while <#QU>Main<#NM>, <#QU>Aux<#NM>, <#QU>LC1/LC2<#NM>, and <#QU>ROM<#NM> restrict the breakpoint to those views.\n"
"\n"
...
"\n"
"<#H2>Machine Configuration Dialog<#NM>\n"
"The Machine Configuration dialog allows common emulator settings to be edited without manually editing the INI file. It has three tabs: <#QU>Machine<#NM>, <#QU>Emulator<#NM>, and <#QU>Assembler<#NM>.\n"
"\n"
"<#H3>Machine tab<#NM>\n"
"Select the model (<#QU>Apple ][+<#NM> or <#QU>Apple //e Enhanced<#NM>) and the device installed in slots 1-7. On the <#QU>Apple ][+<#NM> model, Slot 3 also allows a <#QU>Franklin Ace Display<#NM> card. A <#QU>Mockingboard<#NM> sound card can be added to any slot.  Currently, only one Mockingboard is allowed in a machine.\n"
"\n"
"<#H3>Emulator tab<#NM>\n"
"Configure the UI (<#QU>GUI<#NM> or <#QU>Text<#NM>), original Delete behavior, scroll wheel speed, and symbol files (a comma-separated list). The symbol files row includes a <#QU>[Browse]<#NM> button. Each file selected through the Browse button is added to the list in the symbol files field. To remove a file, edit the field manually.\n"
"The <#QU>Turbo Speeds<#NM> field accepts comma-separated multipliers such as <#QU>1, 8, max<#NM>. There are also Disk LEDs, and Remember INI settings checkboxes. Selecting the <#QU>Remember INI settings<#NM> option always saves the INI file when the emulator exits.\n"
"\n"
"<#H3>Assembler tab<#NM>\n"
"Select the assembler source file (there is a <#QU>[Browse]<#NM> button), choose the destination bank, and configure <#QU>Reset Stack<#NM>, <#QU>Auto Run<#NM>, and the <#QU>Auto Run Address<#NM>.\n"
"\n"
"<#H3>Common fields<#NM>\n"
"At the bottom is the <#QU>INI file name<#NM> field with its own <#QU>[Browse]<#NM> button, along with <#QU>Save settings on Quit<#NM>, <#QU>[OK]<#NM>, and <#QU>[Cancel]<#NM> buttons. <#QU>[OK]<#NM> applies the changes. <#QU>[Cancel]<#NM> closes the dialog without applying them.\n"
"If the <#QU>INI file name<#NM> is changed, the configuration is saved immediately to the INI file when <#QU>[OK]<#NM> is selected, unless <#QU>Save settings on Quit<#NM> is enabled. In that case, the file will be saved when the emulator exits.\n"
"For clarity, <#QU>Save settings on Quit<#NM> is a one-time option, whereas <#QU>Remember INI settings<#NM> always saves changes. Also note that disk selections and changes for <#QU>DiskII<#NM> and <#QU>SmartPort<#NM> are saved to the INI file as well.\n"
"\n"
...
"\n"
"You can move the selection with the <#QU>Up/Down<#NM> keys (and <#QU>Page Up/Page Down<#NM> to move by a page). Press ENTER or click <#QU>[OK]<#NM> to select the highlighted line. Clicking on any line in the middle section, for example <#QU>A.TEMPPT $0052 A2_BASIC<#NM>, also selects that symbol.\n"
"\n"
...
".scope \"n\"           Open a named scope, also known as a <#QU>Target<#NM>.  See <#H2>Targets<#NM> below\n"
...
"<#QU>*<#NM> For conditional assembly in emulator vs. command line, see <#QU>_asm6502_tool<#NM> below.\n"
"\n"
"<#H2>Targets<#NM>\n"
"Using <#QU>.scope \"name\" [file=\"file name\"[, dest=\"bank name\"]]<#NM> it is possible to define new output targets.  A target is similar to a sub-project.  For example, you may use the following:\n"
"<#QU>\n"
...
".endscope\n"
"<#NM>\n"
"The <#QU>file=<#NM> option is used by the command line assembler to write the generated output into the named file.  The <#QU>dest=<#NM> option is used by the assembler in the emulator to send the bytes to the named destination.  The destination is still subject to the output address specifiers (<#QU>.org<#NM> or <#QU>* =<#NM>), but it specifies which bank will be mapped when the address is written.  The names for <#QU>dest=<#NM> are:\n"
"<#QU>\n"
...
"<#NM>\n"
"These can be combined. For example <#QU>dest=\"aux,lc2\"<#NM> will put the auxiliary <#QU>LC2<#NM> at <#QU>$D000<#NM>.  These words are all case-insensitive.\n"
"\n"
"<#H2>_asm6502_tool<#NM>\n"
"The variable <#QU>_asm6502_tool<#NM> is set to <#QU>1<#NM> when using the command-line assembler, allowing conditional behavior between emulator and command-line assembly:\n"
"<#QU>\n"
...
".endif\n"
"<#NM>\n"
"Using conditional assembly together with <#QU>.scope \"name\"<#NM> allows optional inclusion of components (e.g., disk loaders).\n"
"\n"
"<#H2>The following dot directives work with dot commands:<#NM>\n"
...
"<#QU>*<#NM> a2m uses dot comparison operators instead of symbols (for example <#QU>.lt<#NM> vs <#QU><<#NM>)\n"
"\n"
...
"original_del         Value <#QU>on<#NM> or <#QU>1<#NM> makes Backspace send Apple II DEL\n"
...
"\n"
"<#TB>Variable             Value<#NM>\n"
"sNdX                 Franklin Ace Display. The <#QU>N<#NM> in <#QU>sNdev<#NM> is a slot number, usually 3. <#QU>X<#NM> is <#QU>0<#NM>\n"
"\n"
...
"\n"
"<#TB>Variable             Value<#NM>\n"
"sNdX                 Adds a Mockingboard audio card to slot <#QU>N<#NM>.  <#QU>X<#NM> is <#QU>0<#NM>\n"
"\n"
"<#H1>Debug Section<#NM>\n"
...
"<#QU>break = <address[-address]>[,<pc|read|write|access|map|main|aux|lc1|lc2|rom|c100rom|c100map|d000map|reset|fast|slow|swap sNdX|tron|troff|type str|count[,reset]><#NM>\n"
"\n"
...
"<#BO>* <#QU>map/main/aux/lc1/lc2/rom/c100rom/c100map/d000map<#NM> set the breakpoint bank view for ini breakpoints.\n"
