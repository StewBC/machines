...
"\n"
"<#H3>Emulator tab<#NM>\n"
"Configure the UI (<#QU>GUI<#NM> or <#QU>Text<#NM>), the scroll wheel speed, and symbol files (a comma-separated list). The symbol files row includes a <#QU>[Browse]<#NM> button. Each file selected through the Browse button is added to the list in the symbol files field. To remove a file, edit the field manually.\n"
