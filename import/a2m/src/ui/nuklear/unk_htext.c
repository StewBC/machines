...
"\n"
"<#H3>Machine tab<#NM>\n"
"Select the model (<#QU>Apple ][+<#NM> or <#QU>Apple //e Enhanced<#NM>) and the device installed in slots 1-7. On the <#QU>Apple ][+<#NM> model, Slot 3 also allows a <#QU>Franklin Ace Display<#NM> card.\n"
"\n"
"<#H3>Emulator tab<#NM>\n"
