The nuklear folder holds the implementation for a library that is the A2M UI (GUI) implemented using the nuklear immediate mode "C" GUI library (and is called the UNK library in code).  I use Nuklear with an SDL2 backend.
