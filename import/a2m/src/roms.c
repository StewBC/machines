...
const int apple2_rom_size = sizeof(apple2_rom) / sizeof(apple2_rom[0]);

uint8_t apple_character_rom[] = {
...
const int apple_character_rom_size = sizeof(apple_character_rom) / sizeof(apple_character_rom[0]);
