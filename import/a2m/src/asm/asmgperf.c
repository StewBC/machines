...
hash (register const char *str, register size_t len)
{
  static unsigned short asso_values[] =
    {
      ...
      359, 359, 359, 359, 359, 359, 359, 359, 359, 359,
      359, 359, 359, 359, 359, 359, 359, 359, 359, 359,
      359, 359, 359, 359, 359, 359,  35, 359, 359, 359,
        5, 359, 359,   0, 359,   0, 359, 359, 359, 359,
      359, 359, 359, 359, 359,  25,  25,   0,  10,   0,
        5,   0, 359,  60,  12,  60,   2,   2,  25,  50,
       55,  55, 100,   5,   0, 117,   5,  37,  90,  50,
       70, 359, 359, 359, 359, 359, 359,  25,  25,   0,
       10,   0,   5,   0, 359,  60,  12,  60,   2,   2,
       25,  50,  55,  55, 100,   5,   0, 117,   5,  37,
       90,  50,  70, 359, 359, 359, 359, 359, 359, 359,
      359, 359, 359, 359, 359, 359, 359, 359, 359, 359,
      359, 359, 359, 359, 359, 359, 359, 359, 359, 359,
      359, 359, 359, 359, 359, 359, 359, 359, 359, 359,
      359, 359, 359, 359, 359, 359, 359, 359, 359, 359,
  ...
  return len + asso_values[(unsigned char)str[2]] + asso_values[(unsigned char)str[1]+1] + asso_values[(unsigned char)str[0]] + asso_values[(unsigned char)str[len - 1]];
}
