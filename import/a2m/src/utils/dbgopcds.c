...
const char **opcode_hex_params;
const char **opcode_symbol_params;
const int *opcode_lengths;

const char *opcode_text_6502[256] = {
    [0x00] = "BRK ",
    [0x01] = "ORA ",
    [0x02] = "--- ",
    [0x03] = "--- ",
...
const char *opcode_text_65c02[256] = {
    [0x00] = "BRK ",
    [0x01] = "ORA ",
    [0x02] = "--- ",
    [0x03] = "--- ",
...
const char *opcode_hex_params_6502[256] = {
    [0x00] = "",                                            // 1
    [0x01] = "($%02X,X)",                                   // 2
    [0x02] = "",                                            // 1
    [0x03] = "",                                            // 1
...
const char *opcode_hex_params_65c02[256] = {
    [0x00] = "",                                            // 1
    [0x01] = "($%02X,X)",                                   // 2
    [0x02] = "",                                            // 1
    [0x03] = "",                                            // 1
...
const char *opcode_symbol_params_6502[256] = {
    [0x00] = "",                                            // 1
    [0x01] = "(%s,X)",                                      // 2
    [0x02] = "",                                            // 1
    [0x03] = "",                                            // 1
...
const char *opcode_symbol_params_65c02[256] = {
    [0x00] = "",                                            // 1
    [0x01] = "(%s,X)",                                      // 2
    [0x02] = "",                                            // 1
    [0x03] = "",                                            // 1
...
const int opcode_lengths_6502[256] = {
    [0x00] = 1,                                             // BRK
...
const int opcode_lengths_65c02[256] = {
    [0x00] = 1,                                             // BRK
    [0x01] = 2,                                             // ORA (Indirect,X)
    [0x02] = 1,                                             // UNDEFINED
    [0x03] = 1,                                             // UNDEFINED
