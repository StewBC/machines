...
* Mockingboard  
  - The files hardware files via6522, ay38910 and mboard were generated by Codex in an experiment to learn more about "agentic coding".  The result works, even if it doesn't sound great.  I am likely not going to try and improve it.
  - When the machine reboots, the MB isn't fully reset.  It needs a OA+CTRL+RESET (ALT+F2) to fully reset the MB.  If not, it may well not be detected a second time.
* General  
